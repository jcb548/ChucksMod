...
public class PoweredCrusherScreen extends AbstractEnergyCookerScreen<PoweredCrusherScreenHandler> {
    ...
    protected void renderProgressArrow(DrawContext context, int x, int y){
        if(handler.isCrafting()){
            context.drawTexture(getTexture(),x + 84, y + 35, 176, 0, 16, handler.getScaledProgress(16));
        }
    }
}
