...
public class TriafiaFoliagePlacer extends FoliagePlacer {
    public static final Codec<TriafiaFoliagePlacer> CODEC = RecordCodecBuilder.create(triafiaFoliagePlacerInstance ->
            fillFoliagePlacerFields(triafiaFoliagePlacerInstance).and(Codec.intRange(0, 12).fieldOf("height")
                    .forGetter(placer -> placer.height)).apply(triafiaFoliagePlacerInstance, TriafiaFoliagePlacer::new));
    private final int height;
    public TriafiaFoliagePlacer(IntProvider radius, IntProvider offset, int height) {
        super(radius, offset);
        this.height = height;
    }
    ...
    protected FoliagePlacerType<?> getType() {
        return ModFoliagePlacerTypes.TRIAFIA_FOLIAGE_PLACER;
    }
