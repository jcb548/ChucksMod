...
public class TriafiaTrunkPlacer extends TrunkPlacer {
    public static final Codec<TriafiaTrunkPlacer> CODEC = RecordCodecBuilder.create(objectInstance ->
            fillTrunkPlacerFields(objectInstance).apply(objectInstance, TriafiaTrunkPlacer::new));

    public TriafiaTrunkPlacer(int baseHeight, int firstRandomHeight, int secondRandomHeight) {
        super(baseHeight, firstRandomHeight, secondRandomHeight);
    }

    @Override
    protected TrunkPlacerType<?> getType() {
        return ModTrunkPlacerTypes.TRIAFIA_TRUNK_PLACER;
    }
