...
import net.chuck.chucksmod.block.entity.experience_drain.TitaniumExperienceDrainBlockEntity;
...
import net.chuck.chucksmod.block.entity.generator.lava.TriafiumLavaGeneratorBlockEntity;
...
public class ModBlockEntities {
    ...
    public static BlockEntityType<TitaniumCleanserBlockEntity> TITANIUM_CLEANSER;
    ...
    public static BlockEntityType<TitaniumExperienceDrainBlockEntity> TITANIUM_EXPERIENCE_DRAIN;
    ...
    public static BlockEntityType<TriafiumExperienceDrainBlockEntity> TRIAFIUM_EXPERIENCE_DRAIN;
    ...
    public static void registerBlockEntities() {
        ...
        TITANIUM_CLEANSER = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                new Identifier(ChucksMod.MOD_ID, "titanium_cleanser"),
                FabricBlockEntityTypeBuilder.create(TitaniumCleanserBlockEntity::new,
                        ModBlocks.TITANIUM_CLEANSER).build());
        EnergyStorage.SIDED.registerForBlockEntity((blockEntity, direction) -> blockEntity.energyStorage,
                TITANIUM_CLEANSER);
        FluidStorage.SIDED.registerForBlockEntity((blockEntity, direction) -> blockEntity.fluidStorage,
                TITANIUM_CLEANSER);
        ...
        TITANIUM_EXPERIENCE_DRAIN = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                new Identifier(ChucksMod.MOD_ID, "titanium_experience_drain"),
                FabricBlockEntityTypeBuilder.create(TitaniumExperienceDrainBlockEntity::new,
                        ModBlocks.TITANIUM_EXPERIENCE_DRAIN).build());
        ...
        TRIAFIUM_EXPERIENCE_DRAIN = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                new Identifier(ChucksMod.MOD_ID, "triafium_experience_drain"),
                FabricBlockEntityTypeBuilder.create(TriafiumExperienceDrainBlockEntity::new,
                        ModBlocks.TRIAFIUM_EXPERIENCE_DRAIN).build());
        ...
        TRIAFIUM_LAVA_GENERATOR = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                new Identifier(ChucksMod.MOD_ID, "triafium_lava_generator"),
                FabricBlockEntityTypeBuilder.create(TriafiumLavaGeneratorBlockEntity::new,
                        ModBlocks.TRIAFIUM_LAVA_GENERATOR).build());
        EnergyStorage.SIDED.registerForBlockEntity((blockEntity, direction) -> blockEntity.energyStorage,
                TRIAFIUM_LAVA_GENERATOR);
        FluidStorage.SIDED.registerForBlockEntity((blockEntity, direction) -> blockEntity.fluidStorage,
                TRIAFIUM_LAVA_GENERATOR);

        TRIAFIUM_COPIER = Registry.register(Registries.BLOCK_ENTITY_TYPE,
                new Identifier(ChucksMod.MOD_ID, "triafium_copier"),
                FabricBlockEntityTypeBuilder.create(TriafiumCopierBlockEntity::new,
                        ModBlocks.TRIAFIUM_COPIER).build());
        EnergyStorage.SIDED.registerForBlockEntity((blockEntity, direction) -> blockEntity.energyStorage,
                TRIAFIUM_COPIER);
        FluidStorage.SIDED.registerForBlockEntity((blockEntity, direction) -> blockEntity.fluidStorage,
                TRIAFIUM_COPIER);
