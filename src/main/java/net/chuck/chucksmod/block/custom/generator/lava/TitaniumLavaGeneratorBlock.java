...
public class TitaniumLavaGeneratorBlock extends AbstractLavaGeneratorBlock{
    public TitaniumLavaGeneratorBlock(Settings settings) {
        super(settings);
    }
    @Nullable
    @Override
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new TitaniumLavaGeneratorBlockEntity(pos, state);
    }
    @Nullable
    @Override
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if(player.getStackInHand(hand).getItem() instanceof BucketItem && world.getBlockEntity(pos) instanceof
            ...
            NamedScreenHandlerFactory screenHandlerFactory = (TitaniumLavaGeneratorBlockEntity) world.getBlockEntity(pos);
