 ...
 */
public class FluidTankSyncS2CPacket {
    public static void receive(MinecraftClient client, ClientPlayNetworkHandler handler,
        ...
        if (client.world != null) {
            if (client.world.getWorldChunk(pos).getBlockEntity(pos) instanceof AbstractFluidTankBlockEntity tank) {
                tank.setFluidStorage(variant, xpLevel);
            }
        }
    }
}
