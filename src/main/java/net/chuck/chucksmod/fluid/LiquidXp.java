...
public abstract class LiquidXp extends FlowableFluid {
    @Override
    ...
    public Fluid getFlowing() {
        return ModFluids.FLOWING_LIQUID_XP;
    }

    @Override
    public Item getBucketItem() {
        return ModFluids.LIQUID_XP_BUCKET;
    }

    @Override
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.LIQUID_XP_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
