...
import net.chuck.chucksmod.screen.harvester.TriafiumHarvesterScreen;
...
import net.chuck.chucksmod.screen.quarry.TriafiumQuarryScreen;
...
public class ChucksModClient implements ClientModInitializer {
    ...
    private void registerEntityRenderers(){
        ...
        EntityModelLayerRegistry.registerModelLayer((ModModelLayers.TRIAFIAN_COW), TriafianCowModel::getTexturedModelData);
        EntityRendererRegistry.register(ModEntities.TRIAFIAN_COW, TriafianCowRenderer::new);
    ...
    private void registerCutoutBlocks(){
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.IRON_EXPERIENCE_DRAIN, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TITANIUM_MACHINE_BASE, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TRIAFIUM_MACHINE_BASE, RenderLayer.getCutout());

        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.COAL_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.IRON_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.COPPER_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.GOLD_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TIN_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.LAPIS_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.REDSTONE_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.DIAMOND_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TITANIUM_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.EMERALD_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TRIAFIUM_CROP, RenderLayer.getCutout());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.NETHERITE_CROP, RenderLayer.getCutout());
    ...
    private void registerTranslucentBlocks(){
        ...
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.IRON_MACHINE_BASE, RenderLayer.getTranslucent());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TITANIUM_MACHINE_BASE, RenderLayer.getTranslucent());
        BlockRenderLayerMap.INSTANCE.putBlock(ModBlocks.TRIAFIUM_MACHINE_BASE, RenderLayer.getTranslucent());
    }
    private void registerHandledScreens(){
        ...
        HandledScreens.register(ModScreenHandlers.TRIAFIUM_QUARRY_SCREEN_HANDLER, TriafiumQuarryScreen::new);
        HandledScreens.register(ModScreenHandlers.TITANIUM_HARVESTER_SCREEN_HANDLER, TitaniumHarvesterScreen::new);
        HandledScreens.register(ModScreenHandlers.TRIAFIUM_HARVESTER_SCREEN_HANDLER, TriafiumHarvesterScreen::new);
