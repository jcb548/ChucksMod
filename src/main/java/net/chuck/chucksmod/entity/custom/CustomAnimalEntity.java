...
public abstract class CustomAnimalEntity extends AnimalEntity implements MeleeAttackMob{
    public final AnimationState idleAnimationState = new AnimationState();
    protected int idleAnimationCooldown = 0;
    public final AnimationState attackAnimationState = new AnimationState();
    public int attackAnimationCooldown = 0;
    public CustomAnimalEntity(EntityType<? extends AnimalEntity> entityType, World world) {
